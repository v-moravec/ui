...
export const defineMiniSearchOptions2 = <DataItem>(options: MiniSearchOptions<DataItem>) => {
  return ref(options)
}

export const searchDocs = async <DataItem>(
  search: MaybeRefOrGetter<string>,
  options: { miniSearch?: MaybeRefOrGetter<MiniSearchOptions<DataItem>> } = {}
) => {
...
const useIndexedMiniSearch = <DataItem>(
  search: MaybeRefOrGetter<string>,
...
const useMiniSearch = function <T = any>(
  search: MaybeRefOrGetter<string>,
